...
class POVImageConverterGUI:
    def __init__(self, root):
        ...
        # Settings variables
        # NOTE: HEIGHT is FIXED at 31 (matching display LEDs 1-31), WIDTH is scaled proportionally
        self.height_var = tk.IntVar(value=31)  # Fixed: matches 31 display LEDs (LED 1-31)
    ...
    def update_preview(self):
        ...
        try:
            ...
            # LED 31 (top of 31 display LEDs) maps to image top
