...
- LED 0 is reserved as a sacrificial level-shift LED
"""
...
POV_HEIGHT = 31  # LEDs 1-31 are used for display; LED 0 is sacrificial

def convert_image_for_pov(input_path, output_path=None, height=POV_HEIGHT, max_width=200, 
    ...
    maps correctly: LED 1 (bottom display pixel) shows the bottom of the image and LED 31 (top)
    ...
    try:
        ...
        # No vertical flip needed - LED 1 is the bottom display pixel, LED 31 is the top
...
def convert_image_to_pov_data(input_path, height=POV_HEIGHT, max_width=400, enhance_contrast=True,
...
def save_as_pov(input_path, output_path=None, height=POV_HEIGHT, max_width=400,
...
def print_usage():
    ...
    print(f"  --height N    Target height in pixels (default: {POV_HEIGHT})")
