...
def test_proportional_scaling():
    ...
    # Test case 4: Already close to target height
    ...
    print()
    print("Key points:")
    print("  - Height is always fixed at 31 pixels (31 display LEDs; LED 0 is sacrificial)")
    ...
    print("  - Hardware level shifter used (LED 0 sacrificed for level shifting)")
