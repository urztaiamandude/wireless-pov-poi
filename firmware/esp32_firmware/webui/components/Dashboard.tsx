      ...
      try {
        ...
        if (res.ok) {
          ...
          if (typeof data.powerMode === 'number') {
            const mapped = (['performance', 'balanced', 'powersave', 'ultrasave'][data.powerMode] ?? 'balanced') as PowerMode;
            setPowerModeState(mapped);
          } else if (typeof data.powerMode === 'string') {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-800">
                  ...
                  <input
                    type="range" min="10" max="1000" value={localFrameRate}
                    onChange={(e) => { const v = parseInt(e.target.value); if (!isNaN(v)) handleFrameRateChange(Math.max(10, Math.min(1000, v))); }}
